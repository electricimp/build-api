...
```
npm install build-api
```

## Instantation

The imp object *must* be instantiated with an API key - you can optionally pass an apiBase and apiVersion parameter to overload the defaults.
